 ...
 */
final class Version20201229213339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6629A8ADB403044 ON schoolclasses (mentor_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6629A8ADB403044 ON schoolclasses');
